...
from vibe.utils.vis import batch_visualize_preds
from vibe.data_utils.img_utils import get_single_image_crop, convert_cvimg_to_tensor


def extract_features(model, video, bbox, debug=False, batch_size=200, kp_2d=None, dataset=None, scale=1.3):
    '''
    :param model: pretrained HMR model, use vibe/models/hmr.py:get_pretrained_hmr()
